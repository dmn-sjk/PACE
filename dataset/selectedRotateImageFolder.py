...
def prepare_test_data(args, use_transforms=True, semi=False):
    if args.corruption == 'original' or args.corruption == 'rendition':
    ...
    elif args.dataset in ['domainnet126']:
        pass
    else:
    ...
    if args.dataset == 'domainnet126':
        if args.corruption == 'original':
            teset = DomainNet126(args.dataroot, 'real')
        else:
            teset = DomainNet126(args.dataroot, args.corruption)
