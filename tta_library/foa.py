...
class FOA(TTAMethod):
    ...
    def __init__(self, model:PromptViT, *args, **kwargs):
        ...
        self.fitness_lambda = self.args.fitness_lambda
    ...
    def forward(self, x, y=None):
        ...
        for j, prompt in enumerate(prompts):
            ...
            outputs, loss, batch_mean = forward_and_get_loss(x, self.model, self.fitness_lambda, self.train_info, shift_vector,
